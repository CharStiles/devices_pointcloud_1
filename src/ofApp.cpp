...
void ofApp::setup() {
	...
	ofLoadImage(dudvTex, "waterDUDV4.png");
	ofLoadImage(normalTex, "waterNormal4.png");
...
void ofApp::draw() {
	...
	if (drawIsa){
		...
		isaShader.setUniform1f("time",ofGetElapsedTimef());
